...
from ssltraining.simsiam import TrainSIMSIAM
from models import Backbone
from datetime import datetime
from augmentations import get_dino_augmentations, get_swav_augmentations, get_simsiam_augmentations
...
def main():
    ...
    elif args["experiment"]["ssl_training"].lower() == "swav":
        data_augmentation_transforms = get_swav_augmentations(**args["ssl augmentation kwargs"])
    ...
    if args["experiment"]["ssl_training"] is None:
        ...
        ssl_training = TrainSWAV(
            ...
            final_weight_decay = args["optimizer"]["final_wd"],
            scheduler_warmup_epochs = args["optimizer"]["scheduler_warmup_epochs"],
            start_warmup_lr = args["optimizer"]["start_warmup_lr"],
            num_crops = args["ssl augmentation kwargs"]["num_crops"],
            crops_for_assign = args["ssl augmentation kwargs"]["crops_for_assign"],
            temperature = args["ssl augmentation kwargs"]["temperature"],
            sinkhorn_iterations = args["ssl augmentation kwargs"]["sinkhorn_iterations"],
            epsilon = args["ssl augmentation kwargs"]["epsilon"],
            num_prototypes = args["ssl augmentation kwargs"]["num_prototypes"],
            queue_length = args["ssl augmentation kwargs"]["queue_length"],
            epoch_queue_starts = args["ssl augmentation kwargs"]["epoch_queue_starts"],
            freeze_prototypes_niters = args["ssl augmentation kwargs"]["freeze_prototypes_niters"],
